        ...
        >
            ...
            <div className="relative z-10 w-full max-w-6xl mx-auto px-6 py-12 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-24">
                ...
                >
                    ...
                    <motion.div variants={listItemVariants} className="flex flex-wrap gap-4">
                        {[
                            { label: 'AI INDEXING', icon: Sparkles },
                            { label: 'O-1 DISTRIBUTION', icon: ShieldCheck },
                            { label: 'LIQUID UI', icon: Sparkles }
                        ].map((item, idx) => (
                            <div
                                key={idx}
                                className="px-6 py-3 rounded-2xl glass border border-border/50 text-[10px] font-black uppercase tracking-widest text-foreground flex items-center gap-2"
                            >
                ...
                >
                    <Card className="rounded-[3rem] p-10 shadow-2xl border-border/50 glass relative overflow-hidden">
                        ...
                        <div className="mb-10 text-center lg:text-left">
                            <h3 className="text-2xl font-black text-foreground uppercase tracking-tight mb-2">Sync Account</h3>
                            <p className="text-[10px] font-black uppercase text-muted-foreground tracking-widest opacity-60">Authentication required for synchronization</p>
                        </div>

                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="space-y-3">
                                <Label className="text-[10px] font-black uppercase tracking-widest ml-1 opacity-70">Identity / Email</Label>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between px-1">
                                    <Label className="text-[10px] font-black uppercase tracking-widest opacity-70">Sequence / Password</Label>
                                    <Link to="#" className="text-[10px] font-black uppercase text-primary-600 tracking-widest hover:text-primary-500 transition-colors">Recover</Link>
                                </div>
                                <div className="relative group">
                            ...
                            <div className="flex items-center gap-2 px-1">
                                <Checkbox id="remember" className="rounded-lg border-border/50 data-[state=checked]:bg-primary-500 data-[state=checked]:border-none" />
                    ...
                    <div className="mt-8 flex justify-center gap-6 opacity-40">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-widest">O-AUTH READY</span>
                    </div>
                </motion.div>
            </div>
        </motion.div>
