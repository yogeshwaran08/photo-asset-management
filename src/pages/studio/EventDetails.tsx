        ...
        <div className="flex h-full w-full bg-[#fcfcfc] dark:bg-zinc-950 overflow-hidden font-sans">
            ...
            {activeTab === 'settings' && (
                <div className="w-[260px] bg-white border-r border-border/10 flex flex-col z-30 shrink-0 h-full">
                    <div className="flex-1 overflow-y-auto p-5 space-y-6 scrollbar-hide pt-8 relative">
                        <div className="space-y-4">
                            <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground px-2">Configuration</h3>
                            <div className="space-y-1">
                                <button
                                    onClick={() => setSettingsTab('general')}
                                    className={cn(
                                        "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all group",
                                        settingsTab === 'general' ? "bg-zinc-800 text-white shadow-lg shadow-zinc-800/30" : "text-muted-foreground hover:bg-zinc-50"
                                    )}
                                >
                                    <Settings size={14} className={settingsTab === 'general' ? "text-white" : "text-muted-foreground group-hover:text-foreground"} />
                                    <span className="text-[9px] font-black uppercase tracking-wider">General</span>
                                    {settingsTab === 'general' && <motion.div layoutId="settings-active" className="ml-auto w-1.5 h-1.5 rounded-full bg-white" />}
                                </button>
                                ...
                                <button
                                    ...
                                    className={cn(
                                        "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all group",
                                        settingsTab === 'privacy' ? "bg-zinc-800 text-white shadow-lg shadow-zinc-800/30" : "text-muted-foreground hover:bg-zinc-50"
                                    )}
                                >
                                    <Shield size={14} className={settingsTab === 'privacy' ? "text-white" : "text-muted-foreground group-hover:text-foreground"} />
                                    <span className="text-[9px] font-black uppercase tracking-wider">Privacy</span>
                                    {settingsTab === 'privacy' && <motion.div layoutId="settings-active" className="ml-auto w-1.5 h-1.5 rounded-full bg-white" />}
                                </button>
                                ...
                                <button
                                    ...
                                    className={cn(
                                        "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all group",
                                        settingsTab === 'downloads' ? "bg-zinc-800 text-white shadow-lg shadow-zinc-800/30" : "text-muted-foreground hover:bg-zinc-50"
                                    )}
                                >
                                    <Download size={14} className={settingsTab === 'downloads' ? "text-white" : "text-muted-foreground group-hover:text-foreground"} />
                                    <span className="text-[9px] font-black uppercase tracking-wider">Downloads</span>
                                    {settingsTab === 'downloads' && <motion.div layoutId="settings-active" className="ml-auto w-1.5 h-1.5 rounded-full bg-white" />}
                                </button>
                            </div>
                        </div>
                    </div>
                                    ...
                                    {['7d', '30d', '90d'].map((period) => (
                                        <button
                                            ...
                                            className={cn(
                                                ...
                                                analyticsPeriod === period ? "bg-zinc-800 text-white shadow-md" : "text-muted-foreground hover:bg-zinc-50 hover:text-zinc-900"
                                            )}
                                        >
                                            {period}
                                        </button>
