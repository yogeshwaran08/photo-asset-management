                ...
                <div className="lg:col-span-2 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-slate-500 text-sm">Event creation and storage trends</p>
                        </div>
                        <select className="bg-slate-50 dark:bg-slate-800 border-none rounded-lg px-3 py-1 text-sm">
